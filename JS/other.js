/*
 * @Author: 冷弋白
 * @LastEditTime: 2021-02-17 13:26:53
 */
(function () {
  var timer;
  var arr = [];
  ...
  for (let i = 0; i < inputLight.length; i++) {
    ...
    inputLight[i].addEventListener("mouseup", function () { //输入框方块行为
      TVFocusBehavior()
      flag = true;
      TVFace(6);
...
introduce.addEventListener('mousedown', function () {
  ...
  LYB.innerHTML = "来自小电视";
  head.src = "IMG/TV！.png";
  Tip('人家说的话如果超过了15个字，将会在15/3+2秒后消失，低于15字则在/2+2秒后消失，人家与一个复制体重叠，它是记录人家被主人按下滑动后的位置，它可不会盯着主人的鼠标摇头晃脑哦！我呢，每次被主人按下并滑动就会花费一秒时间来与人家的复制体重合，主人松手后，人家又会花费一秒时间回来继续盯着主人的鼠标啦，所以主人按下鼠标滑动的时候，最好滑动一秒以上吧，不然会很奇怪的！主人感觉不适应的话可以不让人家盯着主人的鼠标看哦，对了，整个网页不会因为主人缩小浏览器窗口而导致排版凌乱，主人双击人家的头像后，人家背后的白点就会消失！');
