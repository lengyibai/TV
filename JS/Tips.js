...
function Tip(str) {
    ...
    setTimeout(() => {
        setTimeout(() => {
            ...
            setTimeout(() => {
                headPortrait.style.animation = 'headImgUp .75s ease-out forwards'
...
function noviceGuide() {
    ...
    if (NGNum == 5) {
        ...
        if (getChromeVersion()) {
            ...
            if (version < 80) { //别改
                Tip(
                    '您的浏览器内核版本为' + version + '，未达到最低使用版本80，请您下载<a href="https://www.google.cn/intl/zh-CN/chrome/" style="color:rgb(0, 123, 255);" target="_blank"><img src="IMG/chrome.png" style="width: .233rem;height: .233rem;vertical-align: middle;">谷歌浏览器Chrome</a>或系统自带的新版<a href="https://www.microsoft.com/zh-cn/edge" style="color:rgb(0, 123, 255);" target="_blank"><img src="IMG/Edge.png" style="width: .233rem;height: .233rem;vertical-align: middle;">Microsoft Edge</a>'
                );
                skip.style.display = "none";
                assistant.style.display = "none";
            } else {
                Tip(
                    '您的浏览器内核版本为' + version + '，达到了最低使用版本80！'
                );
            }
        }
        //不跳过
                ...
                setTimeout(() => {
                    for (let i = 0; i < help.length; i++) {
                        ...
                        setTimeout(() => {
                            ...
                            help[i].style.backgroundColor = "rgba(255, 255, 255, .75)";
                            help[i].style.textShadow = "0 0.5px 1px rgba(0, 0, 0, 0.5)";
