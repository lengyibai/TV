...
var getSetHideBgColor = document.querySelector(".HideBgColor input"); //隐藏房间输
...
var getSetArr = [
    ...
    getSetBgAutoRot, //房间自动旋转
    getSetBloAutoRot, //小电视自动旋转
    getSetDisImg, //360°全景图
    getSetXLimit, //锁定90°
    getSetBgFlRot, //禁止房间跟随鼠标旋转
...
var helpArr = [
    ...
    '「 灵敏度：输入的值低于1后，就开始变得很灵敏，如果太灵敏而觉得晕，您可以试试开启"禁止房间跟随鼠标"或"隐藏房间" 」',
    "「 隐藏房间：隐藏后可以设置虚空背景色，不过纯色并没有什么好看的，觉得太花可以使用此选项，一般设置为暗色，觉得太亮可以试试下面的护眼模式 」",
    "「 矩形转圆形：变圆只是六面变圆，它始终是个空心 」",
    "「 禁用X轴旋转：开启后小电视将不会向下旋转，只会旋转Y轴，也就是左右旋转 」",
    "「 禁用Y轴旋转：开启后小电视将不会左右旋转，只会旋转X轴，也就是上下旋转 」",
    "「 房间自动旋转：开启后小电视也会自动开启自动旋转，与房间同步，还可以调节两者速度，此时鼠标无法控制房间及小电视旋转。另外，关闭房间自动旋转后小电视也会关闭 」",
    "「 小电视自动旋转：一般用于开启房间自动旋转后再关闭此项，关闭后小电视可以被鼠标控制旋转 」",
    '「 360°全景图：开启后，为了更好的体验，房间和小电视上下旋转范围将锁定为90度，您可以关闭"全景Y轴锁定±90°"来即可解除锁定 」',
    ...
    "「 禁止房间跟随鼠标：在关闭的情况下，房间和小电视将同时被鼠标控制旋转，开启后，房间将固定在开启前的位置 」",
    "「 禁止小电视跟随鼠标：最初增加这个设置只是为了将房间旋转到自己喜欢的颜色的位置，再配合禁止房间跟随鼠标来固定位置，但现在感觉并没有什么用 」",
    "「 上帝视角：开启后房间可以控制旋转的，但小电视却不能，因为小电视在房间内，房间外鼠标无法触碰到小电视，所以就无法控制小电视，也无法唤醒小电视 」",
    ...
    "「 切换播放模式：切换为蓝牙模式后，音乐会提前250毫秒播放，来抵消蓝牙带来的延迟 」<li style='color:rgb(220, 53, 69);'>注意：当在网页断开或连接蓝牙后，需刷新网页再切换，否则可能会导致扬声器与蓝牙延迟混乱</li>",
    ...
    "「 重置小电视及房间位置：小电视重叠着一个小电视的复制体，它不会像小电视那样盯着鼠标，它是负责记录小电视被您按下鼠标后滑动的位置，每次一松手小电视又会转回来继续盯着您的鼠标，而复制体原地不动，当您再按下鼠标，小电视会旋转到与复制体重叠的角度，所以复制体只会受您鼠标按下的控制，除非您关闭了'小电视目光跟随'，复制体将会隐藏，详情请看'小电视目光跟随'的帮助按钮。按下时会有一秒感觉小电视的动作响应速度慢，属于正常现象，因为小电视正在与复制体重叠，1秒后恢复，因此这个选项准确来说是用于小电视的复制体回到初始位置，关闭了'小电视目光跟随'后，此选项也就针对小电视使用了 」",
];
var inputNameArr = [
    "旋转时间",
    "体积大小",
